function varargout = TXT2RES(varargin)
% TXT2RES MATLAB code for TXT2RES.fig
%      TXT2RES, by itself, creates a new TXT2RES or raises the existing
%      singleton*.
%
%      H = TXT2RES returns the handle to a new TXT2RES or the handle to
%      the existing singleton*.
%
%      TXT2RES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TXT2RES.M with the given input arguments.
%
%      TXT2RES('Property','Value',...) creates a new TXT2RES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TXT2RES_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TXT2RES_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TXT2RES

% Last Modified by GUIDE v2.5 26-Feb-2019 09:56:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TXT2RES_OpeningFcn, ...
                   'gui_OutputFcn',  @TXT2RES_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TXT2RES is made visible.
function TXT2RES_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TXT2RES (see VARARGIN)

% Choose default command line output for TXT2RES
...
% UIWAIT makes TXT2RES wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = TXT2RES_OutputFcn(hObject, eventdata, handles) 
